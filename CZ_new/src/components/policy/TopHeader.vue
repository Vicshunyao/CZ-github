...
<template>
    <el-header>
        <div class="left">
            ...
            <span style="margin-left:10px;">江苏常州经济开发区公共服务平台</span>
        </div>
        <div class="right">
        <div class="icon0"><el-icon :size="15"  color="black"> <Grid /></el-icon></div>
        <div class="icon0"><el-icon :size="15"  color="black"> <Tools /></el-icon></div>
...
import { Menu ,User,Tools,Grid } from "@element-plus/icons-vue";
