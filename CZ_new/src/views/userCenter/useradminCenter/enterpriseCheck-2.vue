<template>
    <div class="app-container">
        <div class="new">
            ...
            <el-table :data="qiyeList" @selection-change="handleSelectionChange" style="width: 100%">
                <el-table-column type="selection" width="55" text-align="center" />
                <!-- <el-table-column label="用户编号" width="55" align="center" prop="userId" /> -->
                <el-table-column label="公司名称" text-align="center" prop="name" />
                <el-table-column label="公司地址" text-align="center" prop="address" />
                <!-- <el-table-column label="企业规模" align="center" prop="mass" /> -->
                <!-- <el-table-column label="联系方式" text-align="center" prop="contactPhone" /> -->
                <el-table-column label="法人" align="center" prop="contactName" />
                ...
                <el-table-column label="认证状态" align="center" prop="auditStatus" />
                <el-table-column label="营业证图" align="center" prop="licenseImgUrl">
                    <template #default="{ row }">
                        <img :src="row.businessLicensePath" style="height:30px" />
                    </template>
                </el-table-column>
                            ...
                            <div class="grid-content bg-purple">
                                <el-form :model="detailCompany" :rules="rules" ref="ruleForm" label-width="120px"
                                    ...
                                    <el-form-item label="联系人手机号" prop="contactPhone">
                                        {{ findList.contactPhone }}
                                    </el-form-item>

                                    <el-form-item label="营业证图">
                                        <template slot-scope="scope">
                                            <!-- <img
                          :src="findList.addressDetailed"
                          width="70px"
                          height="30px"
                        /> -->
                                        </template>
...
export default {
    ...
    methods: {
        ...
        getenterpriseList() {
            this.loading = true;
            qiye.enterpriseList(this.ListForm).then((res) => {
                console.log(res.data.records)
                this.qiyeList = res.data.records;
            })
        ...
        getById(row) {
            ...
            this.FindId.id = row.id;
            // const enterpriseId = row.id || this.ids;
            // console.log(enterpriseId);
            this.open = true;
            qiye.enterpriseFindById(this.FindId).then((res) => {
                console.log(res);
