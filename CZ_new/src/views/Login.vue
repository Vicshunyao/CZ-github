  ...
  <div class="login">
    ...
    <div class="login_right">
      ...
      <div class="main">
        <div class="form">
          <div class="id">
            <el-input placeholder="手机号码/账户名" @keyup.enter.native="login" v-model="username">
      ...
      <el-radio label="ENTERPRISE_ACCOUNT" value="ENTERPRISE_ACCOUNT">企业账户登录</el-radio>

    </el-radio-group>
        </div> -->
          <!-- <div class="sms" v-if="loginBySms">
          <el-input v-model="verifyCode" placeholder="验证码" class="verifyCode">
      ...
      <!-- <div class="form">
        ...
        <div class="choice">
          <el-radio-group v-model="accountType">
      <el-radio label="PERSONAL_ACCOUNT" value="PERSONAL_ACCOUNT">个人</el-radio>
      <el-radio label="ENTERPRISE_ACCOUNT" value="ENTERPRISE_ACCOUNT">企业</el-radio>
      <el-radio label="SYSTEM_ADMIN_ACCOUNT" value="SYSTEM_ADMIN_ACCOUNT">系统管理</el-radio>
      <el-radio label="GOVERNMENT_ACCOUNT" value="SYSTEM_ADMIN_ACCOUNT">政府账户</el-radio>
      <el-radio label="ADMIN_ACCOUNT" value="SYSTEM_ADMIN_ACCOUNT">服务商</el-radio>
    </el-radio-group>
        </div>
        <div class="sms" v-if="loginBySms">
          <el-input v-model="verifyCode" placeholder="验证码" class="verifyCode">
...
export default {
  ...
  created() {
    ...
    window.localStorage.getItem("creditCode")
      ...
      : "";
    window.localStorage.getItem("auditStatus")
      ? (this.auditStatus = window.localStorage.getItem("auditStatus"))
      : "";
      ...
      commonApi.login({
        ...
        .then((res) => {
          ...
          if (res.code === 200) {
            ...
            localStorage.setItem("creditCode", res.data.creditCode);
            localStorage.setItem("auditStatus", res.data.auditStatus);
            // this.$router.push("/");
            console.log(this.username);
            ...
            // this.$router.go(-1);
            if (this.accountType === "ENTERPRISE_ACCOUNT") {
              this.$router.push("/");
              console.log(res.data);
            } else {
              this.$router.push("/index");
