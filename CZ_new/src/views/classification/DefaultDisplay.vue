...
const currentPageData = inject('SearchPageData');
...
// }
const sharedData = inject('SearchPageData');
...
onMounted(() => {
  ...
  tableData111.value = window.localStorage.getItem("tableData.value")
    ? (tableData111.value = window.localStorage.getItem("tableData.value"))
    : "";
    console.log(tableData111)
