...
<template>
  <div class="body">
    <div>
      <el-table :data="tableData1.slice((query.page - 1) * query.page_size,
        query.page * query.page_size)" @row-click="openFile">
    ...
    <div> <el-pagination :total="tableData1.length" :current-page="query.page" :page-size="query.page_size"
        :page-sizes="[5, 10, 20, 50, 100]" layout=" total, sizes, prev, pager, next" background
        @current-change="handleCurrentChange" @size-change="handleSizeChange" @pagination="getpolicyList"></el-pagination>
    </div>
  </div>
</template>
