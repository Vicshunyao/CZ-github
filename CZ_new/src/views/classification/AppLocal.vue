...
array1.value=  res.data.records.filter((item, index) => {
              ...
              return item.name == '国家级';})    
              array12.value=  res.data.records.filter((item, index) => {
              return item.name == '省级';})    
              array13.value=  res.data.records.filter((item, index) => {
              return item.name == '市级';})    
              array14.value=  res.data.records.filter((item, index) => {
              return item.name == '区级';})    
...
<template>
  ...
  <el-table :data="array14" @row-click="openFile">
